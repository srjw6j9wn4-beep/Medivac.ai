...
const RECENTLY_CLOSED: ClosedTender[] = [
  {
    ...
    portalName: "Buy.NSW",
      ...
      price_positioning: "Competitive — incumbents typically price to retain.",
      tech_differentiators: "NSW Ambulance CAD integration was a procurement requirement Pel-Air already met.",
      incumbent_advantage: "Strongest factor — transition risk avoidance almost always favours the incumbent unless performance has failed.",
    },
    contract_value: "$38M (2-year base + extensions)",
    type: "Panel Arrangement",
    scope: "Intra-hospital fixed-wing transfer across NSW — primarily Western NSW LHD, Far West, Hunter New England. King Air class aircraft, 24/7 standby.",
    region: "NSW",
    fit: "VERY HIGH",
    missed_reason: "No registered vendor profile on Buy.NSW at time of RFT release. Capability statement did not demonstrate Medivac.ai dispatch platform differentiator.",
  ...
  },
  {
    ...
    portalName: "QTenders",
      ...
      price_positioning: "Multi-operator panel keeps pricing competitive — lowest-cost-per-sector wins individual task orders.",
      compliance_advantage: "QLD Government supplier registration and insurance already in place for incumbents.",
    },
    contract_value: "~$62M over 3 years",
    type: "Standing Offer Arrangement (SOA)",
    scope: "Government passenger transport, VIP charter, law enforcement support, medical evacuation support — statewide QLD including remote regions.",
    region: "QLD",
    fit: "HIGH",
    missed_reason: "Not registered on QTenders portal. No ITAR-cleared aircraft for law enforcement variant. Panel arrangements often have lower barriers — a sub-tender was available.",
  ...
  },
  {
    ...
    portalName: "UN Global Marketplace",
      ...
      price_positioning: "UN LTAs are evaluated on USD day-rate plus mobilisation cost — local operators have near-zero mobilisation cost vs Australian-based competitors.",
      compliance_advantage: "UNGM registration and ICAO international ops certification were mandatory prerequisites not met by Australian bidders.",
      tech_differentiators: "UN requires specific cargo configuration and medevac certification that Pacific operators maintain permanently.",
    },
    contract_value: "USD $4.2M over 2 years",
    type: "Long-term Agreement (LTA)",
    scope: "Medical supply delivery, immunisation campaign support, emergency child protection airlift — Pacific island network. Medevac capability required.",
    region: "Pacific",
    fit: "HIGH",
    missed_reason: "UNGM registration was not active. No ICAO international operator certificate lodged. Response time requirement (4 hrs Fiji → outer islands) requires pre-positioned crew.",
  ...
  },
  {
    ...
    portalName: "WA Tenders",
      ...
      price_positioning: "RFDS WA operates as a charity with government co-funding — their effective hourly rate undercuts commercial operators on long-term contracts.",
      compliance_advantage: "WA Government procurement requires an Indigenous Employment Plan and local community benefit statement — RFDS WA has these embedded.",
      incumbent_advantage: "WA Country Health and RFDS WA have a joint operations culture — clinical handover protocols are already co-designed.",
    },
    contract_value: "$95M over 5 years",
    type: "Contract (exclusive service agreement)",
    scope: "Primary and inter-hospital aeromedical transfer across WA — Kimberley, Pilbara, Goldfields, Mid-West, Wheatbelt. Night capability required. PC-12 / King Air class.",
    region: "WA",
    fit: "HIGH",
    missed_reason: "No WA base or sub-contracted LAME support in WA. Indigenous Employment Plan not prepared. WA Government preference for WA-based operators.",
  ...
  },
  {
    ...
    portalName: "Buy.NSW",
      ...
      price_positioning: "Rex and Inland bid incremental cost on existing scheduled services — near impossible for a dedicated charter operator to match on per-kg rates.",
      tech_differentiators: "Cold chain packaging and chain-of-custody tracking was the key requirement — both operators met minimum standard.",
    },
    contract_value: "$8.5M over 3 years",
    type: "Panel Arrangement",
    scope: "Urgent biological specimen transport — time-critical pathology samples (blood products, transplant tissue, forensic) from regional NSW to Sydney laboratories. IFR required.",
    region: "NSW",
    fit: "MEDIUM",
    missed_reason: "Panel was not flagged internally — no keyword alert set on Buy.NSW for 'pathology' or 'specimen'. Lower profile than NEPT but high-frequency, low-complexity revenue.",
  ...
  },
  {
    ...
    portalName: "AusTender",
      ...
      price_positioning: "Specialist capability — AMSA was not price-optimising, they were capability-buying. Cobham's effective rate per flight hour is high but the alternative is no capability.",
      tech_differentiators: "Integrated EO/IR/SAR radar sensor suite is the core procurement requirement — not available on King Air or PC-12 without a major avionics programme.",
      compliance_advantage: "Defence Industry Security Program (DISP) clearance required for maritime patrol data handling.",
    },
    contract_value: "~$18M over 3 years",
    type: "Exclusive contract",
    scope: "Maritime surveillance patrols, search and rescue coordination flights, pollution monitoring — East Coast including Torres Strait. Long-range (>4 hrs endurance).",
    region: "AU Federal",
    fit: "MEDIUM",
    missed_reason: "Scope required FLIR/EO sensor suite and maritime radar not fitted to current fleet. Endurance requirement exceeded B200/B350 unrefuelled range for outer Torres Strait sectors.",
    lesson: "Monitor next AMSA cycle (~2029). Consider sensor suite capability gap as a medium-term fleet investment. AMSA panel opportunities with shorter sector requirements may be more accessible.",
  },
  {
    ref: "GT-NSW-001",
    title: "NSW Health Non-Emergency Patient Transport (Ground) — Western NSW LHD Panel",
    agency: "NSW Health / Western NSW LHD",
    closed: "2025-08-15",
    type: "Panel Arrangement",
    scope: "Ground NEPT services across Western NSW including Dubbo, Orange, Bathurst. Road transfers from regional hospitals to metro facilities.",
    region: "NSW",
    fit: "HIGH",
    awarded_to: "Not disclosed",
    contract_value: "$2.8M/yr",
    bid_submitted: false,
    our_outcome: "",
    missed_reason: "Did not bid — no ground fleet at time of tender",
    lesson: "Ground transfer fleet acquisition would make this a high-value add-on to existing air NEPT contract",
    notes: "Panel arrangement — re-opens 2027",
  },
  {
    ref: "GT-FED-001",
    title: "Federal Dept of Defence — Medical Ground Transport Services (Joint Health Command)",
    agency: "Department of Defence — Joint Health Command",
    closed: "2025-11-20",
    type: "Standing Offer Arrangement (SOA)",
    scope: "Non-emergency ground medical transport for ADF personnel and dependants at Holsworthy, Randwick, and Williamtown bases.",
    region: "AU Federal",
    fit: "MEDIUM",
    awarded_to: "Not disclosed",
    contract_value: "$1.2M/yr",
    bid_submitted: false,
    our_outcome: "",
    missed_reason: "Not registered on Defence procurement portal (AusTender)",
    lesson: "Register on AusTender. Defence contracts require baseline security clearances.",
    notes: "SOA — re-tender expected 2027",
  },
  {
    ref: "MIL-001",
    title: "ADF Aeromedical Evacuation Support — Domestic Contingency Contract",
    agency: "Department of Defence — Air Force",
    closed: "2025-06-10",
    type: "Exclusive Contract",
    scope: "Domestic MEDEVAC support for ADF exercises and contingency operations. Fixed-wing air ambulance, crew cleared to Baseline security. Eastern states focus.",
    region: "AU Federal",
    fit: "MEDIUM",
    awarded_to: "Toll Medical Transport",
    contract_value: "$8.5M/yr",
    bid_submitted: false,
    our_outcome: "",
    missed_reason: "Baseline security clearance process not initiated. Toll has incumbent ADF relationship.",
    lesson: "Initiate baseline security clearances for pilots and medical crew — opens ADF, Border Force, AFP contract opportunities.",
    notes: "Re-tender expected 2028",
  },
];
