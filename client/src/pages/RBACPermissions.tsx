...
const DEFAULT_PERMS: PermMatrix = {
  pilot: {
    ...
    "mission-optimiser": "read", "special-missions": "read", "ops-tasks": "read", "pilot-handover": "full",
    // Tech & Journey Log
    "tech-log": "full",
    // People & Aircraft
  ...
  nurse: {
    ...
    "mission-optimiser": "read", "special-missions": "full", "ops-tasks": "read", "pilot-handover": "read",
    "tech-log": "none",
  ...
  ordering_nurse: {
    ...
    "mission-optimiser": "none", "special-missions": "read", "ops-tasks": "read", "pilot-handover": "none",
    "tech-log": "none",
  ...
  doctor: {
    ...
    "charter-quote": "none", "ora": "read", "flight-planning": "none",
    "mission-optimiser": "read", "special-missions": "full", "ops-tasks": "read", "pilot-handover": "none",
    "tech-log": "none",
    "org-chart": "read", "roster": "read", "frms": "none", "aircraft": "none",
    "engineering": "none", "maint-planner": "none", "asset-utilisation": "none",
    "ferry": "none", "techlog": "none", "check-training": "none", "regulations": "read",
  ...
  dispatcher: {
    ...
    "mission-optimiser": "full", "special-missions": "full", "ops-tasks": "full", "pilot-handover": "full",
    "tech-log": "read",
  ...
  engineer: {
    ...
    "charter-quote": "none", "ora": "none", "flight-planning": "none",
    "mission-optimiser": "none", "special-missions": "none", "ops-tasks": "read", "pilot-handover": "read",
    "tech-log": "full",
  ...
  safety: {
    ...
    "mission-optimiser": "read", "special-missions": "read", "ops-tasks": "read", "pilot-handover": "read",
    "tech-log": "read",
  ...
  senior_management: {
    ...
    "mission-optimiser": "full", "special-missions": "full", "ops-tasks": "full", "pilot-handover": "read",
    "tech-log": "read",
